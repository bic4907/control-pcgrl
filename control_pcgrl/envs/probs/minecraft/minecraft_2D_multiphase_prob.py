...
"""
class Minecraft2DmultiphaseProblem(Problem):
    """
    ...
    def get_reward(self, new_stats, old_stats):
        ...
        print(new_stats["regions"])
        print(new_stats["path-length"])

        with open('get_reward.log', 'w+') as f:
            f.write(str(new_stats["regions"]))
            f.write(str(new_stats["path-length"]))
