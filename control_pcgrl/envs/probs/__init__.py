...
from control_pcgrl.envs.probs.minecraft.minecraft_2D_multiphase_prob import Minecraft2DmultiphaseProblem
...
PROBLEMS = {
    ...
    "minecraft_2D_multiphase": Minecraft2DmultiphaseProblem,
